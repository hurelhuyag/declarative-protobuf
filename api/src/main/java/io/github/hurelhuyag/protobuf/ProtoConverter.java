 ...
 * {@code Long}, {@code String}, {@code ByteString}, ...) for a scalar or enum field, or a {@code @ProtoMessage}
 ...
 * the wire default ({@code 0}, {@code ""}, {@code ByteString.EMPTY}) when the field is absent, and a value whose
